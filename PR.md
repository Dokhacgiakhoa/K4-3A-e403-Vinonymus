...
Nhánh này gộp thêm nhánh `main` mới nhất (PR Discord Activity + 50 golden case của Đức) để tránh xung đột khi merge.
...
| File | Thay đổi |
|---|---|
| `README.md` | Dòng backend trong bảng Trạng thái prototype ghi thêm việc đã vá lỗ hổng (gộp cùng dòng Discord Activity của Đức); mục Chạy thử nói rõ để trống biến backend thì không bắt đăng nhập |
| `PR.md` | Mô tả PR này |
