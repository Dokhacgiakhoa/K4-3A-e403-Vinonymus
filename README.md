...
| **AI Helpdesk** | **Có.** Là AI duy nhất người dùng nói chuyện | Tra cứu, giải đáp về tài liệu và lộ trình học, có trích dẫn nguồn | Chatbox (widget chat nổi) | Tính năng nền, không thuộc phần chấm. Widget gọi Agentic RAG thật qua `/api/chat` |
...
| **AI Helpdesk** — widget chat nổi "AI Helpdesk 24/7" | ✅ AI chạy thật | Widget gắn `ChatBox` vào layout toàn app và gọi Agentic RAG qua `/api/chat`; kiến trúc tại [`docs/helpdesk-agent/helpdesk-agent-architecture.md`](docs/helpdesk-agent/helpdesk-agent-architecture.md) |
