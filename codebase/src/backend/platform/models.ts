...
export type LectureDocument = {
  ...
  storage_bucket: string | null; embedding_model: string | null;
  indexed_revision: number | null; indexed_at: string | null;
...
export type PlatformRpc = 'platform_profile' | 'platform_documents' | 'platform_learning' | 'platform_admin';
