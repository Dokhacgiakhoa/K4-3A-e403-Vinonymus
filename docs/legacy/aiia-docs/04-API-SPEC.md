...
```
> Đủ 6 provider, khớp với 6 ô nhập ở trang Cài đặt Key. Riêng **embedding** (tầng 2 và tầng 3) hiện chỉ chạy được bằng key **Gemini** — các provider khác vẫn dùng được cho việc sinh câu trả lời, xem `06-AI-PIPELINE.md` mục 5.
