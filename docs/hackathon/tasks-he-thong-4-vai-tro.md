...
| D-02 [#85](https://github.com/Dokhacgiakhoa/K4-3A-e403-Vinonymus/issues/85) | Bảng tài liệu giảng viên: `lecture_documents`, lịch sử phiên bản, lịch sử duyệt (lấy thiết kế từ PR #69, đổi sang Postgres thuần, bỏ phần Supabase Auth) | D-01 | Migration chạy được; sơ đồ database cập nhật | 14:45 | 🔄 — migration đã chạy idempotent trên Supabase; sơ đồ và PR đang cập nhật |
