...
> Mỗi việc có một GitHub Issue (bấm số `#` cạnh mã việc) — [xem bảng Issues theo checkpoint](https://github.com/Dokhacgiakhoa/K4-3A-e403-Vinonymus/milestones). Đóng issue và cập nhật trạng thái ở đây khi xong việc.
